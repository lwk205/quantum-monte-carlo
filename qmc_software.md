...
1. For a full description see the [current documentation](https://docs.qmcpack.org/qmcpack_manual.pdf) or QMCPACK citation paper: [link](https://iopscience.iop.org/article/10.1088/1361-648X/aab9c3/meta), [PDF](https://arxiv.org/pdf/1802.06922.pdf).
